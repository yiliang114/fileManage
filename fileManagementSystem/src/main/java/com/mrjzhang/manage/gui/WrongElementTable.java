...
//public class WrongElementTable extends JTable {
//	// JTable表分页信息相关变量
...
//	// JTable表信息相关变量
//	public List<Element> wrongElements = Element.wrongElements;
//	public String[] columnNames = { "Name", "Score", "Picture", "Curve" };
//	public DefaultTableModel model = null;
//
//	public WrongElementTable() {
//		initTable();
//	}
//
//	/**
...
//	 * @return
//	 */
//	public Object[][] getData(List<Element> wrongElements) {
//		if (wrongElements.size() > 0) {
//			Object[][] data = new Object[wrongElements.size()][4];
//			for (int i = 0; i < wrongElements.size(); i++) {
//				Element s = wrongElements.get(i);
...
//		Object[][] data = getData(wrongElements);
//		if (data != null) {
//			initResultData(data);
