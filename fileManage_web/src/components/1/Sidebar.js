...
class Sidebar extends React.Component {
  ...
  render() {
    let {hash, collapsed, isIllegal} = this.props.commonStore;
    ...
    if (itemData.children && itemData.children.length) {
      ...
      itemData
        ...
        .forEach(subItemData => {
          ...
          if (subItemData.children && subItemData.children.length) {
            subItemData
              .children
              .forEach(subpage => {
                if (subpage.url === hash) {
